...
public struct Block8x8
{
    ...
    public float this[int index]
    {
        ...
        get
        {
            ...
            ref float selfRef = ref Unsafe.As<Block8x8, float>(ref this);
    ...
    public static Block8x8 operator *(in Block8x8 block, float value)
    {
        ref Block8x8 blockRef = ref Unsafe.AsRef(in block);
    ...
    public void MultiplyInPlace(ref Block8x8 other)
    {
        V0L *= other.V0L;
        V0R *= other.V0R;
        V1L *= other.V1L;
