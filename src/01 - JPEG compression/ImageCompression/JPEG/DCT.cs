...
#pragma warning restore SA1310 // FieldNamesMustNotContainUnderscore
    ...
    public static void TransformIDCT(ref Block8x8 src, ref Block8x8 dest, ref Block8x8 temp)
    {
        ...
        // TODO: What if we leave the blocks in a scaled-by-x8 state until final colour packing?
    ...
    public static void IDCT8x4_LeftPart(ref Block8x8 s, ref Block8x8 d)
    {
        Vector4 my1 = s.V1L;
        Vector4 my7 = s.V7L;
        Vector4 mz0 = my1 + my7;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IDCT8x4_RightPart(ref Block8x8 s, ref Block8x8 d)
    {
        Vector4 my1 = s.V1R;
        Vector4 my7 = s.V7R;
        Vector4 mz0 = my1 + my7;
    ...
    public static void FDCT8x4_LeftPart(ref Block8x8 s, ref Block8x8 d)
    {
        Vector4 c0 = s.V0L;
        Vector4 c1 = s.V7L;
        Vector4 t0 = c0 + c1;
    ...
    /// <param name="s">Source</param>
    /// <param name="d">Destination</param>
    public static void FDCT8x4_RightPart(ref Block8x8 s, ref Block8x8 d)
    {
        Vector4 c0 = s.V0R;
        Vector4 c1 = s.V7R;
        Vector4 t0 = c0 + c1;
    ...
    public static void TransformFDCT(ref Block8x8 src, ref Block8x8 dest, ref Block8x8 temp)
    {
        src.TransposeInto(ref temp);
